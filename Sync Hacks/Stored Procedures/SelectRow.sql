CREATE PROCEDURE dbo.Sync_SelectRow (@ATABLENAME VARCHAR(100)) AS
BEGIN
    ...
    BEGIN
        ...
        SET @CMD = 'CREATE PROCEDURE [dbo].[' + @ATABLENAME + '_selectrow]
        @P_1 Int,
        @sync_scope_local_id Int,
        @sync_scope_restore_count Int AS
        BEGIN
            SELECT '
                + @UPDATE_FIELDS + '
                ...
                case
                    ...
                    then case
                            ...
                            then @sync_scope_restore_count else [side].[local_update_peer_key]
                         end
